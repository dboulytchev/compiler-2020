...
LLlambda_6_7_epilogue:
	...
	popl	%ebp
	ret
	.set	LLlambda_6_7_SIZE,	8

	.set	LSLlambda_6_7_SIZE,	2
...
# BEGIN ("Llambda_11_18", 1, 0, []) / 

	pushl	%ebp
	movl	%esp,	%ebp
	subl	$LLlambda_11_18_SIZE,	%esp
	movl	%esp,	%edi
	movl	$filler,	%esi
	movl	$LSLlambda_11_18_SIZE,	%ecx
	rep movsl	
# LD (Arg (0)) / 
...
# END / 
	...
	movl	%ebx,	%eax
LLlambda_11_18_epilogue:

	movl	%ebp,	%esp
	popl	%ebp
	ret
	.set	LLlambda_11_18_SIZE,	0

	.set	LSLlambda_11_18_SIZE,	0

# LABEL ("Llambda_10_18") / 

Llambda_10_18:

# BEGIN ("Llambda_10_18", 1, 0, []) / 

	pushl	%ebp
	movl	%esp,	%ebp
	subl	$LLlambda_10_18_SIZE,	%esp
	movl	%esp,	%edi
	movl	$filler,	%esi
	movl	$LSLlambda_10_18_SIZE,	%ecx
	rep movsl	
# LD (Arg (0)) / 
...
# END / 
	...
	movl	%ebx,	%eax
LLlambda_10_18_epilogue:

	movl	%ebp,	%esp
	popl	%ebp
	ret
	.set	LLlambda_10_18_SIZE,	0

	.set	LSLlambda_10_18_SIZE,	0
...
# BEGIN ("Llambda_12_24", 2, 0, [Arg (0)]) / 

	pushl	%edx
	pushl	%ebp
	movl	%esp,	%ebp
	subl	$LLlambda_12_24_SIZE,	%esp
	movl	%esp,	%edi
	movl	$filler,	%esi
	movl	$LSLlambda_12_24_SIZE,	%ecx
	rep movsl	
# LD (Access (0)) / 
...
# END / 
	...
	movl	%ebx,	%eax
LLlambda_12_24_epilogue:

	movl	%ebp,	%esp
	popl	%ebp
	popl	%edx
	ret
	.set	LLlambda_12_24_SIZE,	0

	.set	LSLlambda_12_24_SIZE,	0
