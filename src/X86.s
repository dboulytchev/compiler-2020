...
# LABEL ("LprocessBinop_16") / 

LprocessBinop_16:

# BEGIN ("LprocessBinop_16", 4, 0, []) / 

	pushl	%ebp
	movl	%esp,	%ebp
	subl	$LLprocessBinop_16_SIZE,	%esp
	movl	%esp,	%edi
	movl	$filler,	%esi
	movl	$LSLprocessBinop_16_SIZE,	%ecx
	rep movsl	
# LD (Arg (0)) / 
...
# CLOSURE ("LsimpleBinop_44", [Arg (2); Arg (1); Arg (3)]) / 

	pushl	20(%ebp)
	pushl	12(%ebp)
	pushl	16(%ebp)
	pushl	$LsimpleBinop_44
	pushl	$7
	call	Bclosure
	addl	$20,	%esp
	movl	%eax,	%ebx
...
# CLOSURE ("LcompareBinop_44", [Arg (2); Arg (1); Arg (3)]) / 

	pushl	20(%ebp)
	pushl	12(%ebp)
	pushl	16(%ebp)
	pushl	$LcompareBinop_44
	pushl	$7
	call	Bclosure
	addl	$20,	%esp
	movl	%eax,	%ebx
...
# CLOSURE ("LlogicBinop_44", [Arg (2); Arg (1); Arg (3)]) / 

	pushl	20(%ebp)
	pushl	12(%ebp)
	pushl	16(%ebp)
	pushl	$LlogicBinop_44
	pushl	$7
	call	Bclosure
	addl	$20,	%esp
	movl	%eax,	%ebx
...
# CLOSURE ("LdivBinop_44", [Arg (2); Arg (1); Arg (3)]) / 
...
# CLOSURE ("LmodBinop_44", [Arg (2); Arg (1); Arg (3)]) / 
...
# END / 
	...
	movl	%ebx,	%eax
LLprocessBinop_16_epilogue:

	movl	%ebp,	%esp
	popl	%ebp
	ret
	.set	LLprocessBinop_16_SIZE,	0

	.set	LSLprocessBinop_16_SIZE,	0

# LABEL ("LmodBinop_44") / 

LmodBinop_44:

# BEGIN ("LmodBinop_44", 0, 0, [Arg (2); Arg (1); Arg (3)]) / 

	pushl	%edx
	pushl	%ebp
	movl	%esp,	%ebp
	subl	$LLmodBinop_44_SIZE,	%esp
	movl	%esp,	%edi
	movl	$filler,	%esi
	movl	$LSLmodBinop_44_SIZE,	%ecx
	rep movsl	
# LD (Access (0)) / 
...
# END / 
	...
	movl	%ebx,	%eax
LLmodBinop_44_epilogue:

	movl	%ebp,	%esp
	popl	%ebp
	popl	%edx
	ret
	.set	LLmodBinop_44_SIZE,	8

	.set	LSLmodBinop_44_SIZE,	2

# LABEL ("LdivBinop_44") / 

LdivBinop_44:

# BEGIN ("LdivBinop_44", 0, 0, [Arg (2); Arg (1); Arg (3)]) / 

	pushl	%edx
	pushl	%ebp
	movl	%esp,	%ebp
	subl	$LLdivBinop_44_SIZE,	%esp
	movl	%esp,	%edi
	movl	$filler,	%esi
	movl	$LSLdivBinop_44_SIZE,	%ecx
	rep movsl	
# LD (Access (0)) / 
...
# END / 
	...
	movl	%ebx,	%eax
LLdivBinop_44_epilogue:

	movl	%ebp,	%esp
	popl	%ebp
	popl	%edx
	ret
	.set	LLdivBinop_44_SIZE,	8

	.set	LSLdivBinop_44_SIZE,	2

# LABEL ("LlogicBinop_44") / 

LlogicBinop_44:

# BEGIN ("LlogicBinop_44", 1, 0, [Arg (2); Arg (1); Arg (3)]) / 

	pushl	%edx
	pushl	%ebp
	movl	%esp,	%ebp
	subl	$LLlogicBinop_44_SIZE,	%esp
	movl	%esp,	%edi
	movl	$filler,	%esi
	movl	$LSLlogicBinop_44_SIZE,	%ecx
	rep movsl	
# LD (Access (0)) / 
...
# END / 
	...
	movl	%ebx,	%eax
LLlogicBinop_44_epilogue:

	movl	%ebp,	%esp
	popl	%ebp
	popl	%edx
	ret
	.set	LLlogicBinop_44_SIZE,	56

	.set	LSLlogicBinop_44_SIZE,	14

# LABEL ("LcompareBinop_44") / 

LcompareBinop_44:

# BEGIN ("LcompareBinop_44", 1, 0, [Arg (2); Arg (1); Arg (3)]) / 

	pushl	%edx
	pushl	%ebp
	movl	%esp,	%ebp
	subl	$LLcompareBinop_44_SIZE,	%esp
	movl	%esp,	%edi
	movl	$filler,	%esi
	movl	$LSLcompareBinop_44_SIZE,	%ecx
	rep movsl	
# LD (Access (0)) / 
...
# END / 
	...
	movl	%ebx,	%eax
LLcompareBinop_44_epilogue:

	movl	%ebp,	%esp
	popl	%ebp
	popl	%edx
	ret
	.set	LLcompareBinop_44_SIZE,	12

	.set	LSLcompareBinop_44_SIZE,	3

# LABEL ("LsimpleBinop_44") / 

LsimpleBinop_44:

# BEGIN ("LsimpleBinop_44", 1, 0, [Arg (2); Arg (1); Arg (3)]) / 

	pushl	%edx
	pushl	%ebp
	movl	%esp,	%ebp
	subl	$LLsimpleBinop_44_SIZE,	%esp
	movl	%esp,	%edi
	movl	$filler,	%esi
	movl	$LSLsimpleBinop_44_SIZE,	%ecx
	rep movsl	
# LD (Access (0)) / 
...
# END / 
	...
	movl	%ebx,	%eax
LLsimpleBinop_44_epilogue:

	movl	%ebp,	%esp
	popl	%ebp
	popl	%edx
	ret
	.set	LLsimpleBinop_44_SIZE,	4

	.set	LSLsimpleBinop_44_SIZE,	1
