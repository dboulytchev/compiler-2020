...
# BEGIN ("Llambda_0_50", 1, 0, []) / 

	pushl	%ebp
	movl	%esp,	%ebp
	subl	$LLlambda_0_50_SIZE,	%esp
	movl	%esp,	%edi
	movl	$filler,	%esi
	movl	$LSLlambda_0_50_SIZE,	%ecx
	rep movsl	
# LD (Arg (0)) / 
...
# END / 
	...
	movl	%ebx,	%eax
LLlambda_0_50_epilogue:

	movl	%ebp,	%esp
	popl	%ebp
	ret
	.set	LLlambda_0_50_SIZE,	0

	.set	LSLlambda_0_50_SIZE,	0
